...
class ProxyRequestHandlerTestCase(unittest.TestCase):
    ...
    def test_asymmetric_jws_token_plugin(self):
        key = jwt.JWK()
        private_key = open("./tests/fixtures/private.pem").read()
    ...
    def test_asymmetric_jwe_token_plugin(self):
        private_key = jwt.JWK()
        public_key = jwt.JWK()
        private_key_data = open("./tests/fixtures/private.pem").read()
        public_key_data = open("./tests/fixtures/public.pem").read()
